...
* **Windows:** [BICI_v0.62_windows.zip](https://github.com/theITEAM/BICI/releases/download/v0.62/BICI_v0.62_windows.zip). Once unzipped BICI is run by clicking on the “BICI.exe” icon (if the error message “Windows protected your PC” appears, click on “More info” and “Run”).
