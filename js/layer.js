...
class Layer
{
	...
	copy_from_source()
	{
		...
		case "prior_min": case "prior_min_covar": te = inter.bubble.prior.value.min_eqn.te; break;
		case "prior_max": case "prior_max_covar": te = inter.bubble.prior.value.max_eqn.te; break;
		case "prior_eta": te = inter.bubble.prior.value.eta_eqn.te; break;
		case "prior_S": te = inter.bubble.prior.value.S_eqn.te; break;
		case "prior_nu": te = inter.bubble.prior.value.nu_eqn.te; break;
		...
		case "prior_sd": case "prior_sd_covar": te = inter.bubble.prior.value.sd_eqn.te; break;
